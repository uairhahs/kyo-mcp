"""
Core types for kyö-mcp, strictly enforcing the Open Knowledge Format (OKF) v0.2 standard.
...
class OKFConcept(BaseModel):
    ...
    def to_markdown(self) -> str:
        ...
        # Recommended
        if self.title: frontmatter["title"] = self.title
        if self.description: frontmatter["description"] = self.description
        if self.resource: frontmatter["resource"] = self.resource["uri"]
        if self.tags: frontmatter["tags"] = self.tags
